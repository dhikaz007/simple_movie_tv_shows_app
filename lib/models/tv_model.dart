...
class TVModel {
  ...
  TVModel.fromJson(Map<String, dynamic> json) {
    ...
    if(json["results"] is List) {
      results = json["results"] == null ? null : (json["results"] as List).map((e) => TVResults.fromJson(e)).toList();
    }
...
class TVResults {
  ...
  TVResults({this.backdropPath, this.firstAirDate, this.genreIds, this.id, this.name, this.originCountry, this.originalLanguage, this.originalName, this.overview, this.popularity, this.posterPath, this.voteAverage, this.voteCount});
