...
class SearchMovieModel {
  ...
  SearchMovieModel({this.page, this.results, this.totalPages, this.totalResults});
  ...
  SearchMovieModel.fromJson(Map<String, dynamic> json) {
    ...
    if(json["results"] is List) {
      results = json["results"] == null ? null : (json["results"] as List).map((e) => SearchMovieResults.fromJson(e)).toList();
    }
...
class SearchMovieResults {
  ...
  SearchMovieResults({this.adult, this.backdropPath, this.genreIds, this.id, this.originalLanguage, this.originalTitle, this.overview, this.popularity, this.posterPath, this.releaseDate, this.title, this.video, this.voteAverage, this.voteCount});
