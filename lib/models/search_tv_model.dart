...
class SearchTVModel {
  final int page;
  final List<SearchTVResults> results;
  ...
  factory SearchTVModel.fromJson(Map<String, dynamic> json) => SearchTVModel(
        page: json["page"],
        results:
            List<SearchTVResults>.from(json["results"].map((x) => SearchTVResults.fromJson(x))),
...
class SearchTVResults {
  ...
  factory SearchTVResults.fromJson(Map<String, dynamic> json) => SearchTVResults(
        adult: json["adult"],
