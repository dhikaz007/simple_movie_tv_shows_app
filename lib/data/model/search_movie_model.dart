...
class SearchMovieModel {
  ...
  SearchMovieModel.fromJson(Map<String, dynamic> json) {
    ...
    if(json["results"] is List) {
      results = json["results"] == null ? null : (json["results"] as List).map((e) => SearchResults.fromJson(e)).toList();
    }
...
class SearchResults {
  ...
  SearchResults({this.adult, this.backdropPath, this.genreIds, this.id, this.originalLanguage, this.originalTitle, this.overview, this.popularity, this.posterPath, this.releaseDate, this.title, this.video, this.voteAverage, this.voteCount});
