...
class SearchMovieViewModel extends ChangeNotifier {
  ...
  List<SearchMovieResults>? _movieResult = [];
  SearchMovieResults? _movieListResult;
  String _querySearch = '';

  List<SearchMovieResults>? get movieResult => _movieResult;
  SearchMovieResults? get movieListResult => _movieListResult;
